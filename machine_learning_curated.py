...
# Script generated for node Amazon S3
AmazonS3_node1720069693771 = glueContext.getSink(path="s3://data-lake-estudo-udacity/step_trainer/curated/", connection_type="s3", updateBehavior="LOG", partitionKeys=[], compression="snappy", enableUpdateCatalog=True, transformation_ctx="AmazonS3_node1720069693771")
AmazonS3_node1720069693771.setCatalogInfo(catalogDatabase="stedi",catalogTableName="machine_learning_curated")
