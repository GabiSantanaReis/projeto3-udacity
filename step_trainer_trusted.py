...
# Script generated for node Change Schema
ChangeSchema_node1720069433325 = ApplyMapping.apply(frame=AmazonS3_node1720069397928, mappings=[("sensorreadingtime", "long", "sensorreadingtime", "long"), ("serialnumber", "string", "serialnumber", "string"), ("distancefromobject", "int", "distancefromobject", "int")], transformation_ctx="ChangeSchema_node1720069433325")
...
# Script generated for node Join
Join_node1720069435648 = Join.apply(frame1=ChangeSchema_node1720069433325, frame2=RenamedkeysforJoin_node1720069558857, keys1=["serialnumber", "sensorreadingtime"], keys2=["right_serialnumber", "right_timestamp"], transformation_ctx="Join_node1720069435648")
